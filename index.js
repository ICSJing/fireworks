...
class Particle{
    constructor() {
        ...
        //set a time to clean up the fireworks
        setTimeout(()=> {
            this.el.remove();
...
class Firework {
    ...
    update() {
        ...
        this.el.style.left = this.x + 'px';
        this.el.style.top =  this.y + 'px';
        this.vy += 0.15;  //slow down by adding gravity

    }
}


// the frequency to call the update function.
setInterval(() => {
    fireworks.forEach((firework)=>firework.update());
    particles.forEach((particle)=>particle.update());
}, 10);

//every 300 million seconds, create a new firework
setInterval(()=>{
